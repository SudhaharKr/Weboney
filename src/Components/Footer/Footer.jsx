...
const Footer = () => {
  return (
    <div>
      <div className="w-[full] h-[56vh] bg-[#292F42] flex">
        ...
        <div className="py-14">
          ...
          <div className="flex items-center mt-6">
            ...
            <a
              href="tel:+919688885330"
              className="phone mt-1 ml-2 font-roboto text-[17px] text-white opacity-70"
            >
              +91 96888 85330
            </a>
          </div>
      ...
      <div className="fixed bottom-0 left-0 flex justify-end pr-5 w-full">
  <a
    href="https://wa.me/919688885330"
    target="_blank"
    rel="noopener noreferrer"
    className="bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 transition duration-300 ease-in-out"
  >
    <IoLogoWhatsapp  className=" text-[40px] justify-center items-center flex"/>
  </a>
</div>
