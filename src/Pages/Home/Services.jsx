    ...
    <div className="max-w-full  min-h-screen flex flex-col">
      ...
      >
        <div className="flex justify-between px-20 -mt-20 w-full h-full items-center">
          ...
          <div>
            <button className="w-[200px] h-[70px] shadow-2xl flex hover:bg-white leading-[27px] mt-5 hover:text-yellow-600 cursor-pointer transition-all duration-1000 rounded text-white bg-[#353c4e8f] text-[18px] font-roboto items-center justify-center gap-2">
      ...
      <div className="w-full h-[50%] bg-gray-300 px-20 flex justify-between relative p-6">
        {data.map((service) => (
          <div
            key={service.id}
            className="w-[30%] min-h-[620px] bg-white  border-2 -mt-52 rounded flex flex-col gap-y-2 items-center  hover:shadow-lg"
          >
          <div className="group">
              <img
                src={service.bgImage}
                alt={service.name}
                className="w-[320px] ml-4 h-[200px] rounded-t transition duration-500 ease-in-out transform group-hover:scale-110"
              />
              ...
              <button className="hover:text-[#FFE665] absolute px-[120px] bottom-16 flex items-center justify-center gap-2 font-bold font-roboto text-[16px] transition-all duration-700">
