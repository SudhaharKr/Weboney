  ...
  const data = [
    {
      id: 1,
      bgImage:
        "https://www.vocusdigital.com/wp-content/uploads/2022/08/Brand-Gif-1.gif",
      name: "Branding",
    ...
    {
      id: 2,
      bgImage: "https://www.digitalsolutionservices.com/img/services/main.gif",
    ...
    },
    {
      id: 3,
      bgImage:
        "https://mir-s3-cdn-cf.behance.net/project_modules/hd/e7a11f68306231.5b58520d159a3.gif",
      name: "Logo",
    ...
    {
      id: 4,
      bgImage: 'https://i.gifer.com/DXKh.gif',
        ...
        {data.map((res, index) => {
          return (
            <div
              ...
              className="w-[44%] text-white h-[400px] shadow bg-cover bg-center relative group transition-all duration-1000 ease-out"
            >
