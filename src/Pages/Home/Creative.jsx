...
const Creative = () => {
  ...
  return (
    <div className="flex pr-10 pl-10 w-full h-[60vh] items-center bg-yellow-400 bg-opacity-30">
    {contentData.map((item, index) => (
      <div
        key={index}
        className="mt-6 ml-6 flex gap-6 flex-wrap items-center z-50 w-[600px] relative"
      >
        {item.icon}
        <div className="flex flex-col">
          <div className="flex items-center">
            <span className="text-[22px] text-yellow-400 font-barlow">
              {item.number}
            </span>
