    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-center items-center pt-10">
          ...
          <span>/</span>
          <span className="ml-4 font-roboto">Projects</span>
        </div>
      </div>
      ...
      <div className="max-w-screen px-20">
        ...
        <div className="flex pt-4 justify-center">
          {/* Tab 1 */}
          <button
            className={`text-[#292F42] py-4 px-6 block font-roboto text-[16px] font-bold border-6 ${
              activeTab === "Branding" &&
              "border-b-6 border-[#FFE665] bg-[#FFE665] opacity-60"
            }`}
          ...
          <button
            className={`text-[#292F42] py-4 px-6 block font-roboto text-[16px] font-bold border-6 ${
              ...
              "border-b-2 border-[#FFE665] bg-[#FFE665] opacity-60"
            }`}
        ...
        <div className="mt-8">
          ...
          <div className={`${activeTab === "Branding" ? "" : "hidden"}`}>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex justify-center items-center w-[370px] bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="text-white text-center">
                        {/* Image name */}
                        <h2 className="text-3xl font-barlow font-bold">
                          Ss Tally Image
                        </h2>
                        {/* Branding */}
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex justify-center items-center w-[370px] bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="text-white text-center">
                        {/* Image name */}
                        <h2 className="text-3xl font-bold">The Fun Tours</h2>
                        {/* Branding */}
                        <p className="text-lg p-2">Branding</p>
                      </div>
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex justify-center items-center w-[370px] bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="text-white text-center">
                        {/* Image name */}
                        <h2 className="text-3xl font-bold">Trivasia Academy</h2>
                        {/* Branding */}
                        <p className="text-lg p-2">Branding</p>
                      </div>
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex justify-center items-center w-[370px] bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="text-white text-center">
                        {/* Image name */}
                        <h2 className="text-3xl font-bold">Metro Mask</h2>
                        {/* Branding */}
                        <p className="text-lg p-2">Branding</p>
                      </div>
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex justify-center items-center w-[370px] bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="text-white text-center">
                        {/* Image name */}
                        <h2 className="text-3xl font-bold">Infolab</h2>
                        {/* Branding */}
                        <p className="text-lg p-2">Branding</p>
                      </div>
                    </div>
              ...
              <SwiperSlide>
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex justify-center items-center w-[370px] bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
                    ...
                    <div className="text-white text-center">
                      {/* Image name */}
                      <h2 className="text-3xl font-bold font-barlow">Viraj</h2>
                      {/* Branding */}
                      <p className="text-lg p-2 font-roboto">Branding</p>
                    </div>
                  </div>
            ...
            <div
              className={`${activeTab === "Digital Marketing" ? "" : "hidden"}`}
            >
              <Swiper
              slidesPerView={1}
              spaceBetween={30}
            ...
            <div className={`${activeTab === "Logo" ? "" : "hidden"}`}>
            ...
            {/* Tab 4 content (hidden by default) */}
            <div
              className={`${
                activeTab === "Website Development" ? "" : "hidden"
              }`}
            >
              <p className="font-roboto text-[16px] p-6 -mt-8 border-2 bg-[#1B2335] opacity-60 text-white border-gray-800">
                The mission of Weboney – Website Design, Branding and Digital
