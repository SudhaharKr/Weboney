...
import BrandingImage from "../../assets/sstallybrand-370x370.jpg";
import DigitalMarketingImage from "../../assets/delhismm-370x370.png";
import LogoImage from "../../assets/L16.jpg";
import WebsiteDevelopmentImage from "../../assets/sri-gokul-tex-logo-weboney.jpg";
      ...
      <div className="mt-6  py-20 bg-[#F8F9FA]">
        <div className="ml-20 mr-20">
          ...
          <h1 className="text-center mt-6 leading-[42.024px] text-[34px] font-barlow text-[#292F42]">
            Revamping Your Online Presence: Tailored Solutions for Website
            Design, Website Development, and Digital Marketing
          </h1>
        </div>
            ...
            return (
              ...
              >
                <div className="absolute py-1 flex flex-col gap-y-2 bottom-10 px-6 bg-gradient-to-b from-transparent to-[black] w-full">
                 ...
                 <a href="/Branding"><button className="flex items-center gap-2">View More <FaArrowRight /></button></a>   
                  </div>
                </div>
              </div>
            );
