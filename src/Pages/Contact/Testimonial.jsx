    ...
    <div className="p-20 text-center">
      ...
      <div className="flex gap-6">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="w-[460px] h-[80vh] mt-16 border-2 rounded-md group hover:border-[#FFE665] hover:text-red-700">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="p-2 font-roboto text-[16px] pl-5 pr-5 text-justify text-black/60">
                {testimonial.content}
              </p>
            </div>
          </div>
