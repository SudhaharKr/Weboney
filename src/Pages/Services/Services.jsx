        ...
        <div className="flex">
          ...
          >
            ...
            <SwiperSlide className="flex justify-center p-2 gap-6">
                <div className="w-96 h-40 mt-8 border-6">
                  <img
                    src={LogoBrandingDesign}
                    alt="Logo & Branding Design"
                    className="w-full h-[40vh] border-2 rounded-md"
                  />
                  <div className="w-96 h-[100vh] bg-white p-6 border-2 rounded-md">
              ...
              <div className="w-96 h-[40vh] mt-8">
                ...
                />
                <div className="w-96 h-[100vh] bg-white border-2 rounded-md p-6">
                  <h1 className="font-barlow text-2xl font-semibold">
                    Website Design
                  </h1>
                  <hr className="w-90 h-[0.6vh] bg-[#FFE665] mt-4" />
            ...
            {/* Second Slider */}
            <SwiperSlide className="flex justify-center p-2 gap-6">
              <div className="w-96 h-[40vh] bg-slate-400 mt-8">
                <img
                  src={DigitalMarketingImage}
                  alt="Digital Marketing Image"
                  className="w-full h-full border-2 rounded-md"
                />
                <div className="w-96 h-[120vh] bg-white p-6 border-2 rounded-md">
                  <h1 className="font-barlow text-2xl font-semibold">
                    Digital Marketing
                  </h1>
                  <hr className="w-90 h-[0.6vh] bg-[#FFE665] mt-4" />
                  <p className="p-2 px-4 text-justify font-roboto text-[16px] text-black/60">
                    ...
                    digital marketing agency. Our comprehensive website design
                    services encompass everything from design and development to
                    search engine optimization (SEO) and ongoing website
                    maintenance.
                  </p>
                  <div className="text-left p-2 px-4">
                    <button className="flex items-center gap-2 hover:text-[#292F42] text-black/60 font-roboto text-[16px]">
              ...
              <div className="w-96 h-[40vh] bg-slate-400 mt-8">
                <img
                  ...
                  className="w-full h-full border-2 rounded-md"
                />
                <div className="w-96 h-[70vh] relative p-6 border-2 rounded-md">
                  <h1 className="font-barlow text-2xl font-semibold">
                  ...
                  <p className="p-2 px-4 text-justify font-roboto text-[16px] text-black/60">
                    ...
                    network capabilities. They utilize the device`s network
                    connectivity to access computing resources remotely.
                  </p>
